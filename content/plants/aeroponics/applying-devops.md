...
The way the big companies look at downtime and outages is how many **millions** of dollars per _minute_ of downtime. The crux to handling these risks well is well planned highly available infrastructure and rock solid reporting, monitoring, and alerting. 
...
### Easy to add to
If a platform isn't easy to modify or add to it will never take off. The Curated Forest has been built with this kind of flexibility in mind. You do need some software engineering experience, but with a target audience of DIYers. The hope is with an ecosystem that's easy to contribute to, many contributions will come and we'll all get to benefit from the effort. Seeds of contribution planted now sow future features I didn't have to write and issues I didn't have to fix.
