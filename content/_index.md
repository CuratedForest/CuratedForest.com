...
In the same way there are a ton of valid ways to run software, we'll need all the approaches we have to feed the world. With that said, the approach that's appealed to me most personally has been aeroponics - misting the plant roots. It can offer increased production, but is technically difficult and plants are set up to die quickly. Fortunately the problem matches the DevOps mindset, which is utilized by giant technology companies to make sure their servers are always online, naturally. For a more in depth explanation, checkout the [DevOps Approach]({{< ref "plants/aeroponics/applying-devops" >}}) page.
